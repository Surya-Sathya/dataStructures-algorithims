    ...
    def z_algorithim(self, txt: str): 
        ...
        for k in range(2, len(txt)): 
            ...
            if k > r: 
                ...
                if adj_z_score > r-k+1: zk_score = r-k+1
...
txt = "aabcaabxaaazasdfnaabbaaaabbaabccaaababbaab"
...
print(f"Number of comparisons with naive algorithim: {gusfield_z_method.comparison_counter}")
